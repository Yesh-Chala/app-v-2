...
public class imageSlideShow extends MIDlet implements CommandListener { public Form
slide1;public Command Exit;
public Form slide2; public
Form slide3; public Display
...
slide1=new Form("Slide1"); slide1.append(imageitem1);
slide1.addCommand(Exit);
slide2=new Form("Slide2");
slide2.append(imageitem2);
slide2.addCommand(Exit); slide3=new
Form("Slide3");
...
Display display;
public int c=0; public
Form slide1; public
Form slide2; public
Form slide3;
public ThreadRunner(Display display,Form slide1,Form slide2,Form slide3) { this.display =
display;
this.slide1=slide1;
this.slide2=slide2;
this.slide3=slide3;
...
c++;
if(c==1)
display.setCurrent(slide1); else
if(c==2)
display.setCurrent(slide2); else
if(c==3)
display.setCurrent(slide3); else
if(c==4)
c=0;
try
{
